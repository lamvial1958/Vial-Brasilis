...
| Função | Fórmula |
|---|---|
| Dizer que não está bem | Eu não estou me sentindo bem. |
| Descrever sintoma | Estou com dor de/em... / Estou com... (tosse, febre) |
| Perguntar sintoma | O que você está sentindo? |
| Receber recomendação | Vou te dar... / Parece (ser)... |
...
*Eu não estou me sentindo bem. / Como você se sente hoje?*

**B. "Estar com dor de/em + parte do corpo"** (revisão e expansão da PRE-A1.5):
"dor de" + partes sem artigo claro (dor de cabeça, dor de garganta, dor de barriga) · "dor em/nas/no" + partes específicas (dor nas costas, dor no braço, dor na perna).

**C. "Estar com" + sintoma (sem dor):** *Estou com febre. Estou com tosse. Estou com o nariz entupido.*
...
1. Eu não estou me ___ bem. → **sentindo**
2. Estou com dor de ___. → **garganta**
3. Você está com ___ também? → **febre**
4. ___ um resfriado. → **Parece**

**Exercício 2 — Associe a parte do corpo ao sintoma mais provável:**
cabeça → dor de cabeça · garganta → dor de garganta/tosse · barriga → dor de barriga

**Exercício 3 — Conjugue "sentir-se":**
eu ___ (me sinto) · ele ___ (se sente) · nós ___ (nos sentimos)
...
2. Desde quando? → **Desde ontem**
3. Ela está com febre? → **Não**

## 7. Tarefa de Produção Final

Role-play numa farmácia ou posto de saúde: descreva um sintoma (real ou inventado) usando "estou com" e "sentir-se", responda a perguntas do atendente, e receba/repita uma recomendação.

**Checklist de autoavaliação:**
- [ ] Usei "Eu não estou me sentindo bem" ou variação correta
- [ ] Descrevi pelo menos 2 sintomas com "estou com..."
