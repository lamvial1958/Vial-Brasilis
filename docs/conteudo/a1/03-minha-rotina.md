...
| Função | Fórmula |
|---|---|
| Perguntar a hora de um hábito | A que horas você...? |
| Dizer a hora de um hábito | Eu... às... (sete horas / meio-dia) |
| Indicar frequência | sempre / às vezes / nunca + verbo |
...
**A. Presente do indicativo regular:**
| | -AR (trabalhar) | -ER (comer) | -IR (dormir*) |
|---|---|---|---|
| eu | trabalho | como | durmo* |
| você/ele/ela | trabalha | come | dorme |
| nós | trabalhamos | comemos | dormimos |
| vocês/eles/elas | trabalham | comem | dormem |

> *"dormir" tem uma pequena irregularidade na 1ª pessoa (durmo, não "dormo") — comum em verbos -ir com "o" na raiz; será revisitado conforme aparecer em outros verbos.

**B. Advérbios de frequência** — posição antes do verbo principal: *Eu **sempre** almoço em casa. Eu **às vezes** janto fora. Eu **nunca** durmo tarde.*

**C. Horas:** "Que horas são?" → "São sete horas." / "É meio-dia." / "É meia-noite." Para marcar quando algo ocorre: "**às** sete horas", "**ao** meio-dia", "**à** meia-noite".
...
**Exercício 1 — Conjugue o verbo entre parênteses:**
1. Eu ___ (trabalhar) muito cedo. → **trabalho**
2. Ela ___ (almoçar) ao meio-dia. → **almoça**
3. Nós ___ (dormir) às onze. → **dormimos**
4. Eles ___ (comer) às sete da noite. → **comem**

**Exercício 2 — Complete com a hora correta:**
"Eu me levanto ___ sete horas." → **às** · "Eu almoço ___ meio-dia." → **ao**

**Exercício 3 — Ordene os eventos da rotina de Bruno (1 a 4):**
janta às oito (**3**) · levanta às seis e meia (**1**) · dorme às onze (**4**) · almoça ao meio-dia (**2**)
...
2. O que ela faz até o meio-dia? → **Estuda**
3. A que horas ela dorme? → **Às dez e meia**

## 7. Tarefa de Produção Final

Relate sua rotina diária (oral ou escrita), com pelo menos 5 horários, usando ao menos um advérbio de frequência. Depois, compare sua rotina com a de Bruno ou Sofia ("Eu... mas Bruno...").

**Checklist de autoavaliação:**
- [ ] Usei verbos regulares -ar/-er/-ir corretamente conjugados
- [ ] Dei pelo menos 5 horários com "às/ao/à"
