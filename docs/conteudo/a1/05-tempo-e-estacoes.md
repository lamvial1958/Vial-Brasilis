...
| Função | Fórmula |
|---|---|
| Descrever o clima | Faz sol/calor/frio/vento. / Está quente/frio/nublado. / Chove. |
| Perguntar a temperatura | Que temperatura está? / Quantos graus faz? |
| Dizer o que sente | Eu estou com frio/calor. |
...
**A. Clima (verbos/expressões impessoais — sem sujeito definido):**
faz sol / faz calor / faz frio / faz vento · está nublado · chove / está chovendo

**B. Contraste "fazer frio/calor" (o clima) vs. "estar com frio/calor" (a pessoa):**
*"Hoje faz frio no Sul"* (fato sobre o tempo) ≠ *"Eu estou com frio"* (sensação da pessoa) — mesma lógica de "estar com dor" já vista na PRE-A1.5.

**C. Estações no Brasil (hemisfério sul — atenção, inverso do hemisfério norte):**
verão (dez–mar) · outono (mar–jun) · inverno (jun–set) · primavera (set–dez)
...
**Exercício 1 — Complete com a expressão de clima correta:**
1. Em Gramado, em julho, ___ frio. → **faz**
2. No Rio, geralmente ___ sol. → **faz**
3. No Sul, em julho, também ___. → **chove**

**Exercício 2 — Associe a roupa ao clima:**
casaco → frio · óculos de sol → sol · guarda-chuva → chuva

**Exercício 3 — "Fazer" ou "estar com"? Complete:**
"Hoje ___ muito calor." → **faz** · "Eu ___ frio, posso pegar seu casaco?" → **estou com**
...
Escolha 3 cenários climáticos diferentes (ex.: praia no verão, serra no inverno, cidade chuvosa) e sugira, para cada um, o que vestir e o que levar — oral ou por escrito.

**Checklist de autoavaliação:**
- [ ] Usei "faz" para descrever o clima em pelo menos 2 cenários
- [ ] Usei "está com" para uma sensação pessoal
