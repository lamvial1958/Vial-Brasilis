...
| Função | Fórmula |
|---|---|
| Pedir algo educadamente | Eu queria... |
| Perguntar se é para consumir no local | Para comer aqui ou para levar? |
| Perguntar o preço | Quanto custa? / Quanto é? |
| Encerrar o pedido | Mais alguma coisa? / Não, só isso. |
| Avisar restrição alimentar | Eu sou alérgico(a) a... |
| Pedir a conta | A conta, por favor. |
...
1. Eu ___ um café. → **queria**
2. ___ comer aqui ou para levar? → **Para**
3. Quanto ___? → **custa**
4. Eu sou ___ a amendoim. → **alérgico**
5. A ___, por favor. → **conta**

**Exercício 2 — Associe o utensílio ao uso:**
colher→sopa · garfo→carne · faca→cortar · guardanapo→limpar a boca

**Exercício 3 — Calcule e escreva o valor por extenso:**
"Um café (5 reais) + um pão de queijo (3 reais) = ?" → **oito reais**
...
2. O que ela pede para beber? → **Suco de laranja**

## 6. Tarefa de Produção Final

Role-play completo: peça em uma padaria e depois em um restaurante, mencionando uma restrição alimentar e pedindo a conta ao final.

**Checklist de autoavaliação:**
- [ ] Usei "Eu queria..." para pedir
- [ ] Perguntei o preço com "Quanto custa?"
