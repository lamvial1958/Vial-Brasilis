...
Nasalização (pão, não) · "r" forte/fraco (rua/primeira) · "ch"/"lh" (chuveiro/toalha) · /k/ "qu" (quanto/queria)

## 4. Exercícios (com gabarito)

**Exercício 1 — Complete o diálogo:**
1. Tem ___ aqui? → **pão**
2. Quanto ___ o pão? → **é**
3. Eu ___ dois pães. → **queria**
4. Pode me dar ___? → **troco**
5. Obrigado pela ___. → **compra**

**Exercício 2 — Associe o item ao local:** mercado→pão · farmácia→remédio

**Exercício 3 — Calcule e escreva o valor por extenso:**
"2 pães a 4 reais cada = ?" → **oito reais** · "1 escova (7 reais) + 1 sabonete (3 reais) = ?" → **dez reais**
...
2. Quanto Sofia pagou no total? → **Doze reais**

## 6. Tarefa de Produção Final — Projeto Integrador do PRE-A1

Simulação completa de "ida ao mercado e à farmácia" com uma lista de 5 itens, combinando o vocabulário e as funções de **todas as 6 unidades do nível**: peça uma indicação de caminho até o mercado (unidade 2), compre 3 itens perguntando preço (unidades 4 e 6), relate que esqueceu algo no hotel ao voltar (unidade 3), e peça um item na farmácia mencionando um mal-estar leve (unidade 5). Produção oral de 1–2 minutos.

**Rubrica cumulativa do nível PRE-A1:**
| Critério | Peso |
|---|---|
| Cumprimento da tarefa (lista completa + sub-tarefas) | Alto |
| Uso adequado das fórmulas de cada unidade | Alto |
| Compreensibilidade da pronúncia (nasalização, r, ch/lh, qu) | Médio-alto |
| Fluência mínima (sem pausas que quebrem a comunicação) | Médio |

**Checklist final do nível:**
- [ ] Saudei adequadamente ao horário
- [ ] Perguntei se um item estava disponível ("Tem...?")
- [ ] Perguntei o preço e entendi a resposta
- [ ] Pedi pelo menos 2 itens diferentes
- [ ] Pedi troco
